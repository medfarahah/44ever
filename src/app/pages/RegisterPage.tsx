...
import { Lock, Mail, User, Phone, AlertCircle, ArrowLeft, CheckCircle } from "lucide-react";
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm border border-[#A88B5C]/20 p-8 sm:p-10 rounded-lg shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <div className="text-sm text-[#5C5852] tracking-wider">Create Your Account</div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-[#A88B5C]/10 text-center">
              <p className="text-sm text-[#5C5852]">
                ...
                <Link to="/login" className="text-[#A88B5C] hover:text-[#8F7A52] font-medium">
                  Sign In
                </Link>
              </p>
            </div>
